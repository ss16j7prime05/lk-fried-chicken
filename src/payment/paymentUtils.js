...
// Order Detail). ผ่าน uploadImage ตัวกลางตัวเดียวของทั้งแอป ซึ่งจัดการ HEIC ของ iPhone,
// บีบอัดรูปใหญ่, timeout ต่อครั้ง + retry อัตโนมัติเมื่อเน็ตสะดุด, และการันตีว่า promise
// จบเสมอ (ไม่ค้าง). รับ opts ต่อไปยัง uploadImage ได้ (เช่น onProgress / signal).
export async function uploadSlip(file, opts = {}) {
